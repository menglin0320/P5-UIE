...
def parse_args(parse=True, **optional_kwargs):
    ...
    parser.add_argument("--continuous_embed", action='store_true')
    parser.add_argument("--pretrain_embed", action='store_true')
    parser.add_argument("--mean_regularize", action='store_true')
