...
'''
Input template:
choose the only item in [<item_{{item_id}}>]


Target template:
{{groundtruth {{item_ids}}}}
...
template['source'] = "<user_0> <item_{}>"
template['target'] = "<item_{}>"
template['task'] = "relate_inout_embeds"
template['source_argc'] = 1
template['source_argv'] = ['item_id']
template['target_argc'] = 1
template['target_argv'] = ['item_id']
template['id'] = "6-1"
...
all_tasks['relate_inout_embeds'] = task_subgroup_6
...
'''
Input template:
item_{0} {{title}} {{item_list}}.


Target template:
<item_{{groundtruth {{item}}}}>
...
template['source'] = "<item_0> {}, {}."
template['target'] = "<item_{}>"
template['task'] = "learn_title"
template['source_argc'] = 1
template['source_argv'] = ['title', 'item_list']
template['target_argc'] = 1
template['target_argv'] = ['item_id']
template['id'] = "7-1"
...
all_tasks['learn_title'] = task_subgroup_7
...
'''
Input template:
<extra_id_0> <item_{{item}}> {{category_list}}.
...
template['source'] = "<extra_id_0> {}, {}."
template['target'] = "{}"
template['task'] = "learn_category"
template['source_argc'] = 1
template['source_argv'] = ['item_id', 'category']
template['target_argc'] = 1
template['target_argv'] = ['yes_no']
template['id'] = "8-1"
...
all_tasks['learn_category'] = task_subgroup_8

task_subgroup_9 = {}
template = {}
'''
Input template: learn brand
<extra_id_1> {{item}} {{brand_list}}.
...
template['source'] = "<extra_id_1> {}, {}."
template['target'] = "{}"
template['task'] = "learn_brand"
template['source_argc'] = 1
template['source_argv'] = ['item_id', 'brand_list']
template['target_argc'] = 1
template['target_argv'] = ['brand']
template['id'] = "9-1"

task_subgroup_9["9-1"] = template
all_tasks['learn_brand'] = task_subgroup_9

task_subgroup_10 = {}
template = {}
'''
Input template: learn price
<extra_id_2> {}.
...
template['source'] = "<extra_id_2> {}."
template['target'] = "{}"
template['task'] = "learn_price"
template['source_argc'] = 1
template['source_argv'] = ['item_id']
template['target_argc'] = 1
template['target_argv'] = ['price']
template['id'] = "10-1"

task_subgroup_10["10-1"] = template

all_tasks['learn_price'] = task_subgroup_10

task_subgroup_11 = {}
template = {}
'''
Input template: learn user
<extra_id_3> {{name}} {{cand_users}}.
...
template['source'] = "<extra_id_3> {} {}."
template['target'] = "<user_{}>"
template['task'] = "learn_user"
template['source_argc'] = 1
template['source_argv'] = ['name', 'cand_users']
template['target_argc'] = 1
template['target_argv'] = ['user_id']
template['id'] = "11-1"

task_subgroup_11["11-1"] = template

all_tasks['learn_user'] = task_subgroup_11
# ========================================================
